...
public class ModRegistry {
  ...
  public static final RegistryObject<Item> GEARS = ITEMS.register("gears", () -> new ItemTradeCheats(new Item.Properties().maxStackSize(64).group(ModRegistry.TAB)));
  ...
  public static final RegistryObject<Item> GUARD_ITEM = ITEMS.register("guard", () -> new ItemTradeCheats(new Item.Properties().maxStackSize(64).group(ModRegistry.TAB)));
